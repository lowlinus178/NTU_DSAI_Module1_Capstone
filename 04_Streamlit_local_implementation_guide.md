...
**File Name:** `02_SGJobData_cleaned_processed_compressed.csv.gz`
...
Ensure that the following Streamlit python and associated csv gzip-compressed dataset files are downloaded and saved to the same local folder in your local machine:
 - `02_SGJobData_cleaned_processed_compressed.csv.gz`
 - `03_ntu_dsai_module_1_capstone_app.py` 
...
`streamlit run 03_ntu_dsai_module_1_capstone_app.py`
