# ntu_dsai_module_1_capstone_streamlit_app_v12.5.py
...
def load_and_prepare_data():
    ...
    # This is the direct download link for your Google Drive file
    file_id = '12N0UgzsrJNZcqd0OKqkZJP4wkJmwJ49N'
    url = f'https://drive.google.com/uc?export=download&id={file_id}'
    
    # Read the data from the URL instead of the local filename
    df = pd.read_csv(url)
