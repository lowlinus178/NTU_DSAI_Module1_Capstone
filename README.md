...
- This document aims to summarise the steps taken to conceptualise, clean, and process the SG Job dataset to develop and deliver an interactive Streamlit dashboard for a fictitious business case.
