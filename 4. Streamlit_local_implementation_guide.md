...
**File Name:** `2. SGJobData_cleaned_processed_compressed.csv.gz`
...
Ensure that the following Streamlit python and associated csv gzip-compressed dataset files are downloaded and saved to the same local folder in your local machine:
 - `2. SGJobData_cleaned_processed_compressed.csv.gz`
 - `3. ntu_dsai_module_1_capstone_app.py` 
...
`streamlit run "3. ntu_dsai_module_1_capstone_app".py`
